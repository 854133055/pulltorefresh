...
public abstract class PullToRefreshAdapterViewBase<T extends AbsListView> extends PullToRefreshBase<T> implements
    ...
    public final void onScroll(final AbsListView view, final int firstVisibleItem, final int visibleItemCount,
        ...
        if (DEBUG) {
            Log.d(LOG_TAG, "First Visible: " + firstVisibleItem + ". Visible Count: " + visibleItemCount + ". Total " +
     ...
     * {@link android.widget.AdapterView#setAdapter(android.widget.Adapter)} setAdapter(adapter)}. This is just for convenience!
     *
    ...
    /**
     * Pass-through method for {@link PullToRefreshBase#getRefreshableView() getRefreshableView()}.
     * {@link android.widget.AdapterView#setOnItemClickListener(android.widget.AdapterView.OnItemClickListener) setOnItemClickListener(listener)}. This is just
     * for convenience!
     *
    ...
    /**
     * Pass-through method for {@link PullToRefreshBase#getRefreshableView() getRefreshableView()}.
     * {@link android.widget.AdapterView#setOnItemLongClickListener(android.widget.AdapterView.OnItemLongClickListener) setOnItemLongClickListener(listener)}.
     * This is just for convenience!
     * 
     * @param listener - OnItemLongClickListener to use
     */
    ...
    protected void handleStyledAttributes(TypedArray a) {
        ...
        mShowIndicator = a.getBoolean(R.styleable.pub_fw_PullToRefresh_pub_fw_ptrShowIndicator, !isPullToRefreshOverScrollEnabled());
    }
    ...
    private void addIndicatorViews() {
        ...
        if (mode.showHeaderLoadingLayout() && null == mIndicatorIvTop) {
            ...
            params.rightMargin = getResources().getDimensionPixelSize(R.dimen.pub_fw_indicator_right_padding);
